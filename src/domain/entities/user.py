...
class User:
    """
    Entidad User
    Representa un usuario que busca recomendaciones.
    """
    ...
    def __post_init__(self):
        """Validaciones"""
        # Validar coordenadas de Perú (aproximado)
    ...
    def set_preference(self, key: str, value) -> None:
        """Establecer una preferencia del usuario"""
